...
# tl;dr
Semestrální skupinová práce. Cílem bylo zjistit hlavní faktory ovlivňující výskyt diabetu u žen pomocí dat a strojového učení. Použit byl [OpenML Dataset #37 – Diabetes](https://www.openml.org/d/37).
...
# 🔬 Použitý dataset
Pracovali jsme s klasickým datasetem [OpenML Dataset #37 – Diabetes](https://www.openml.org/d/37) zaměřeným na ženy indiánského původu ve věku 21 let a více. Dataset obsahoval atributy jako:
